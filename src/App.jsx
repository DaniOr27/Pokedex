...
function App() {
    ...
    return (
        <section className="bg-[#F6F8FC] h-screen font-outfit overflow-y-auto bg-[url(https://js-pokedex-virid.vercel.app/src/pokeball-icon.png)] bg-no-repeat bg-[-10%_-20%] overflow-x-hidden">
